...
<img src="https://render.githubusercontent.com/render/math?math=\color{black}\left\langle%2B\right|=\frac{1}{\sqrt{2}}\left\langle0\right|%2B\frac{1}{\sqrt{2}}\left\langle1\right|=\frac{1}{\sqrt{2}}\begin{pmatrix}1%261\end{pmatrix}">
...
<img src="https://render.githubusercontent.com/render/math?math=\color{black}\left\langle-\right|=\frac{1}{\sqrt{2}}\left\langle0\right|-\frac{1}{\sqrt{2}}\left\langle1\right|=\frac{1}{\sqrt{2}}\begin{pmatrix}1%26-1\end{pmatrix}">
...
<img src="https://render.githubusercontent.com/render/math?math=\color{black}\left|%2B\right\rangle=\frac{1}{\sqrt{2}}\left|0\right\rangle%2B\frac{1}{\sqrt{2}}\left|1\right\rangle=\frac{1}{\sqrt{2}}\begin{pmatrix}1\\1\end{pmatrix}">
...
<img src="https://render.githubusercontent.com/render/math?math=\color{black}\left|-\right\rangle=\frac{1}{\sqrt{2}}\left|0\right\rangle-\frac{1}{\sqrt{2}}\left|1\right\rangle=\frac{1}{\sqrt{2}}\begin{pmatrix}1\\-1\end{pmatrix}">
